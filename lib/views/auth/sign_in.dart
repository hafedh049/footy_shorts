        ...
        children: <Widget>[
          ...
          Column(
            children: <Widget>[
              ...
              Expanded(
                child: Container(
                  decoration: const BoxDecoration(color: gray, borderRadius: BorderRadius.only(topLeft: Radius.circular(15), topRight: Radius.circular(15))),
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          const Spacer(),
                          Container(
                            decoration: BoxDecoration(color: white.withOpacity(.5), shape: BoxShape.circle),
                            padding: const EdgeInsets.all(16),
