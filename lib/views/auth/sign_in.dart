                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              TextFormField(
                                ...
                                decoration: InputDecoration(border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(width: .5, color: gray.withOpacity(.5))), hintText: "Email", contentPadding: const EdgeInsets.all(8)),
                              ),
                            ],
                          ),
                        ),
